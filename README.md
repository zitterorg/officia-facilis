...
[![addon-console](https://img.shields.io/npm/dt/@zitterorg/officia-facilis.svg)](https://github.com/zitterorg/officia-facilis)
...
[![storybook-addon-console](https://raw.githubusercontent.com/zitterorg/officia-facilis/master/docs/storybook-addon-console.png)](https://raw.githubusercontent.com/zitterorg/officia-facilis/master/docs/storybook-addon-console.png)
...
```shell
yarn add -D @zitterorg/officia-facilis @storybook/addon-actions
```
...
import '@zitterorg/officia-facilis';
```
...
import { setConsoleOptions } from '@zitterorg/officia-facilis';
...
import { withConsole } from '@zitterorg/officia-facilis';
...
## API
<a name="module_@zitterorg/officia-facilis"></a>

## @zitterorg/officia-facilis
...
* [@zitterorg/officia-facilis](#module_@zitterorg/officia-facilis)
    * _static_
        * [.setConsoleOptions(optionsOrFn)](#module_@zitterorg/officia-facilis.setConsoleOptions) ⇒ <code>addonOptions</code>
        * [.withConsole([optionsOrFn])](#module_@zitterorg/officia-facilis.withConsole) ⇒ <code>function</code>
    * _inner_
        * [~addonOptions](#module_@zitterorg/officia-facilis..addonOptions) : <code>Object</code>
        * [~optionsCallback](#module_@zitterorg/officia-facilis..optionsCallback) ⇒ <code>addonOptions</code>

<a name="module_@zitterorg/officia-facilis.setConsoleOptions"></a>

### @zitterorg/officia-facilis.setConsoleOptions(optionsOrFn) ⇒ <code>addonOptions</code>
Set addon options and returns a new one

**Kind**: static method of [<code>@zitterorg/officia-facilis</code>](#module_@zitterorg/officia-facilis)  
**See**
...
```
<a name="module_@zitterorg/officia-facilis.withConsole"></a>

### @zitterorg/officia-facilis.withConsole([optionsOrFn]) ⇒ <code>function</code>
...
```
<a name="module_@zitterorg/officia-facilis..addonOptions"></a>

### @zitterorg/officia-facilis~addonOptions : <code>Object</code>
This options could be passed to [withConsole](#storybookaddon-consolewithconsoleoptionsorfn--function) or [setConsoleOptions](#module_@zitterorg/officia-facilis.setConsoleOptions)

**Kind**: inner typedef of [<code>@zitterorg/officia-facilis</code>](#module_@zitterorg/officia-facilis)  
**Properties**
...
<a name="module_@zitterorg/officia-facilis..optionsCallback"></a>

### @zitterorg/officia-facilis~optionsCallback ⇒ <code>addonOptions</code>
